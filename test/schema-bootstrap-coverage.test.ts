...
const REQUIRED_BOOTSTRAP_COVERAGE: ForwardReference[] = [
  ...
  // v0.34.1 (v60-v65) — forward-referenced by oauth client source-scope
  // indexes/FKs in the schema blob. Old brains have oauth_clients without
  // source_id/federated_read, so bootstrap adds them before schema replay.
